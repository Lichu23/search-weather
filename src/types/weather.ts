...
export class Convert {
    public static toAPIData(json: string): APIData {
        return cast(JSON.parse(json), r("APIData"));
    }

    public static aPIDataToJson(value: APIData): string {
        return JSON.stringify(uncast(value, r("APIData")), null, 2);
    }
}
